...
@interface AspectRatioTest : OCLayAboutTestCase
@end

@implementation AspectRatioTest

-(void)testHeightIsCorrectRatio {
    UIView *twiceAsWide = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 2, 1)] autorelease];
    UIView *fourByThree = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 4.0, 3.0)] autorelease];
